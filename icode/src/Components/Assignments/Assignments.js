export default function Assignments({clicked}) {
    let assignments = [
        {
            qid: 'qid1',
            heading: 'ML-ASSIGNMENT-1',
            description: 'Write a ML program to format the data in the given dataset.'
        },
        {
            qid: 'qid2',
            heading: 'ML-ASSIGNMENT-2',
            description: 'Write a ML program to split the data to into train/test set.'
        }
    ];

    // Rendering Multiple assignments
